...
const datacheck = (0, multer_1.default)();
// S3にファイルアップロード
...
router.post("/", upload.single("image"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existImage = yield prisma.image.findUnique({
            where: { userID: userID },
        });
    ...
    try {
        ...
        if (!image) {
            ...
            return res.status(200).json({
                url: "https://my-portfolio-images-s3.s3.ap-northeast-1.amazonaws.com/default.png",
            });
        }
        res.json(image);
    }
